...
public class Constants {
	public static final String IMAGE_BUCKET = "gfx/bucket.png";
	public static final String IMAGE_APPLE = "gfx/applenew.png";
	public static final String IMAGE_GAPPLE = "gfx/goldapplenew.png";
	...
	public static final int HEIGHT_GAME = 800;
