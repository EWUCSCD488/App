...
public class GameScreen implements Screen, GestureDetector.GestureListener {
  ...
  private void displayStats() {
		...
		this.scoreFont.draw(this.paramSpriteBatch, ""+ game.getScore(), 125, 60);
		...
		if(game.isInvinsible()) {
			...
			this.scoreFont.draw(this.paramSpriteBatch, ""+ (int)((11.0E+009F - (TimeUtils.nanoTime() - invinsibleTime)) / 1000000000), 125, 1075);
		}
